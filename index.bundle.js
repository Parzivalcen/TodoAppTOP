...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/instagram.svg */ "./src/imgs/instagram.svg"), __webpack_require__.b);
var ___CSS_LOADER_URL_IMPORT_1___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/twitter.svg */ "./src/imgs/twitter.svg"), __webpack_require__.b);
...
var ___CSS_LOADER_URL_IMPORT_0___ = new URL(/* asset import */ __webpack_require__(/*! ../imgs/bg-Desktop.jpg */ "./src/imgs/bg-Desktop.jpg"), __webpack_require__.b);
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_sourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
...
if (true) {
  if (!_node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals || module.hot.invalidate) {
    var isEqualLocals = function isEqualLocals(a, b, isNamedExport) {
  if (!a && b || a && !b) {
    return false;
  }
  ...
  return true;
    ...
    var isNamedExport = !_node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;
    var oldLocals = isNamedExport ? _node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__ : _node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;

    module.hot.accept(
      /*! !!../../node_modules/css-loader/dist/cjs.js!./taskPanel.css */ "./node_modules/css-loader/dist/cjs.js!./src/styles/taskPanel.css",
      __WEBPACK_OUTDATED_DEPENDENCIES__ => { /* harmony import */ _node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../node_modules/css-loader/dist/cjs.js!./taskPanel.css */ "./node_modules/css-loader/dist/cjs.js!./src/styles/taskPanel.css");
(function () {
        if (!isEqualLocals(oldLocals, isNamedExport ? _node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__ : _node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals, isNamedExport)) {
                module.hot.invalidate();

                return;
              }

              oldLocals = isNamedExport ? _node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__ : _node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals;

              update(_node_modules_css_loader_dist_cjs_js_taskPanel_css__WEBPACK_IMPORTED_MODULE_6__["default"]);
      })(__WEBPACK_OUTDATED_DEPENDENCIES__); }
    )
  }
...
/* harmony import */ var _modules_taskPanel__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/taskPanel */ "./src/modules/taskPanel.js");
/* harmony import */ var _modules_footer__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/footer */ "./src/modules/footer.js");
...
body.appendChild(_modules_home__WEBPACK_IMPORTED_MODULE_3__.home.header());
// Add new Project/Category
body.appendChild(_modules_sideBar__WEBPACK_IMPORTED_MODULE_4__["default"].CategoryPopUpPanel());
// Toggle to show side panel 
_modules_sideBar__WEBPACK_IMPORTED_MODULE_4__["default"].toggle();

body.appendChild(main);

main.appendChild(_modules_home__WEBPACK_IMPORTED_MODULE_3__.home.hero());

body.appendChild((0,_modules_footer__WEBPACK_IMPORTED_MODULE_6__["default"])())

document.addEventListener('DOMContentLoaded', _modules_addTask__WEBPACK_IMPORTED_MODULE_0__.Task.displayTasks());

/*Take the input user input 
  from the text box, this file is located on ./UI/addTask.js*/  
_modules_addTask__WEBPACK_IMPORTED_MODULE_0__.Task.takeInput('General');
// delete
document.addEventListener('click', (e) => {
  _modules_addTask__WEBPACK_IMPORTED_MODULE_0__.Task.deleteTask(e);
  _modules_addTask__WEBPACK_IMPORTED_MODULE_0__.Task.taskDone(e);
  ...
  _modules_sideBar__WEBPACK_IMPORTED_MODULE_4__["default"].categoryPressed(e);
  _modules_sideBar__WEBPACK_IMPORTED_MODULE_4__["default"].showAddCategoryPanel(e);
  _modules_sideBar__WEBPACK_IMPORTED_MODULE_4__["default"].addNewCategoryBtn(e);
  _modules_sideBar__WEBPACK_IMPORTED_MODULE_4__["default"].deleteCategory(e);
  _modules_taskPanel__WEBPACK_IMPORTED_MODULE_5__["default"].showPanel(e);
  _modules_taskPanel__WEBPACK_IMPORTED_MODULE_5__["default"].getDate(e);
  _modules_taskPanel__WEBPACK_IMPORTED_MODULE_5__["default"].updateNotes(e);
  _modules_taskPanel__WEBPACK_IMPORTED_MODULE_5__["default"].removePanel(e);
  // store.saveDueDate(e);
})
  ...
  static takeInput (tag) {
    ...
    addBtn.addEventListener('click', () => {
      ...
      if(title.length < 3){
        ...
        date = (0,date_fns_format__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(date.replace(/-/g, '/')), 'MM/dd/yyyy');
...
/* harmony export */ });
/* harmony import */ var _StoreTask_store__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../StoreTask/store */ "./src/StoreTask/store.js");
/* harmony import */ var _styles_taskPanel_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../styles/taskPanel.css */ "./src/styles/taskPanel.css");
...
class taskDescPanel {
  ...
  static removePanel(e) {
    if(e.target.classList.contains('hide-desc-panel')){
      _home__WEBPACK_IMPORTED_MODULE_2__.home.clearDescPanel();
      _home__WEBPACK_IMPORTED_MODULE_2__.home.deBlurElements();
    }
  }
    ...
    static getDate (e){
      if (e.target.classList.contains('due-Date-btn')){
        ...
        date = (0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(date.replace(/-/g, '/')), 'MM/dd/yyyy')
        const title = e.target.parentElement.previousElementSibling.firstElementChild.textContent;
        _StoreTask_store__WEBPACK_IMPORTED_MODULE_0__.store.addDate(title, date);
    ...
    static updateDate(title){
      ...
      const task = _StoreTask_store__WEBPACK_IMPORTED_MODULE_0__.store.getSingleTask(title)
    ...
    static updateNotes (e){
      if(e.target.classList.contains('add-task-note')){
        ...
        console.log(taskTitle);
        console.log(notes);
        _StoreTask_store__WEBPACK_IMPORTED_MODULE_0__.store.SaveNotes(taskTitle, notes);
        alert('notes saved');
...
/***/ "./src/imgs/bg-Desktop.jpg":
/*!*********************************!*\
  !*** ./src/imgs/bg-Desktop.jpg ***!
  \*********************************/
/***/ ((module, __unused_webpack_exports, __webpack_require__) => {

module.exports = __webpack_require__.p + "74656ae82718666f40be.jpg";
...
module.exports = __webpack_require__.p + "ca6dab938465408e4613.svg";
